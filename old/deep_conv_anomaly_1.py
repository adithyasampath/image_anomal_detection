...
class AnomalyPredictor:
    def __init__(self):
        ...
        self.weights_dir = os.path.join(
            os.path.dirname(__file__), "weights", "autoencoder-vgg_1.h5")
        ...
        self.median_file = os.path.join(self.initial_image_dir, 'median_1.csv')
        self.train_analysis_file = os.path.join(self.initial_image_dir,
                                                'train_analysis_1.csv')
        ...
        self.test_save_to = os.path.join(self.initial_image_dir, 'anomaly_1')
    ...
    def train_model(self):
        ...
        self.autoencoder.compile(metrics=['acc'],optimizer='adam', loss=ssim_loss)
    ...
    def load_weights(self):
        def ssim_loss(y_true, y_pred):
            return 1-tf.reduce_mean(tf.image.ssim(y_true, y_pred, 1.0))
        self.autoencoder.load_weights(self.weights_dir)
        self.autoencoder.compile(metrics=['acc'],
            optimizer='adam', loss=ssim_loss)
